import { MaterialIconFC, MaterialIconProps, SvgFC, SvgProps } from 'types/MaterialIcon';

function MaterialIcon({ size, fill, children }: MaterialIconProps): MaterialIconFC {
  return (
...
export function FolderIcon({ size, fill }: SvgProps): SvgFC {
  return (
...
export function FileIcon({ size, fill }: SvgProps): SvgFC {
  return (
    <MaterialIcon size={size} fill={fill}>
